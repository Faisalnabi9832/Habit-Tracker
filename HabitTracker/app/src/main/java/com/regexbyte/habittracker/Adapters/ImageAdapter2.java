...
//
//    public ImageAdapter2(List<Uri> imageUris, Context context) {
...
//            ImageViewHolder23 imageViewHolder = (ImageViewHolder23) holder;
//            Uri imageUri = imageUris.get(position);
//            Glide.with(context).load(imageUri).into(imageViewHolder.imageView);
//        } else if (position == 0  && imageUris.size() == 2) {
//            ImageViewHolder33 imageViewHolder2 = (ImageViewHolder33) holder;
//
...
//
//
//class ImageViewHolder23 extends RecyclerView.ViewHolder {
//    ImageView imageView;
//
//
//    public ImageViewHolder23(@NonNull View itemView) {
//        super(itemView);
//        imageView = itemView.findViewById(R.id.parentimage);
//
//    }
//}
//class ImageViewHolder33 extends RecyclerView.ViewHolder {
//    ImageView imageView1,imageView2;
//
//
//    public ImageViewHolder33(@NonNull View itemView) {
//        super(itemView);
//
...
//    }
//}
//class ImageViewHolder122 extends RecyclerView.ViewHolder {
//    ImageView imageView;
//    TextView textView;
//
//    public ImageViewHolder122(@NonNull View itemView) {
//        super(itemView);
